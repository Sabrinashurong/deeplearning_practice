...
class NERModel(LanguageModel):
  ...
  def add_embedding(self):
    ...
    If partition_strategy is "mod" (the default), we assign each id to partition p = id % len(params). For instance, 13 ids are split across 5 partitions as: [[0, 5, 10], [1, 6, 11], [2, 7, 12], [3, 8], [4, 9]]
