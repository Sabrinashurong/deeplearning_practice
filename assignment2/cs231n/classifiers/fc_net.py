...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    """
    affine_relu_forward returns a tuple of:
    ...
    """
    affine_backward Returns a tuple of:
...
class FullyConnectedNet(object):
  ...
  def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
    ...
    ############################################################################
    #print("input: ",input_dim," hidden: ", hidden_dims)
    #self.params['W1'] = np.random.randn(input_dim, hidden_dims[0]) * weight_scale
    #self.params['b1'] = np.zeros(hidden_dims[0])
    #self.params['W2'] = np.random.randn(hidden_dims[1], num_classes) * weight_scale
    #self.params['b2'] = np.zeros(num_classes)
    ############################################################################
    # BATCH NORM STUFF
    ...
    self.params['W1'] = np.random.randn(input_dim, hidden_dims[0]) * weight_scale
    self.params['b1'] = np.zeros(hidden_dims[0])
    # 'b1' is useless if we use batch norm
  ...
  def loss(self, X, y=None):
    ...
    if not self.use_batchnorm:
      ...
      out, self.cache['cache1'] = affine_bn_relu_forward(X, self.params['W1'], 
                                                         self.params['gamma1'], 
                                                         self.params['beta1'], 
                                                         self.bn_params[0])
    ...
    for i in range(2, hidden_layers+1):
      if not self.use_batchnorm:
        out, self.cache['cache'+str(i)] = affine_relu_forward(out, self.params['W'+str(i)],
                                                              self.params['b'+str(i)])
        
      else:
        out, self.cache['cache'+str(i)] = affine_bn_relu_forward(out, self.params['W'+str(i)],
